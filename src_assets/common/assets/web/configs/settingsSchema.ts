    ...
    groups: [
      ...
      },
      {
        ...
        fields: [
          ...
          boolean('pyrowave_enabled'),
          select('pyrowave_precision', [
            option('-1', '_common.auto'),
            option('0', 'config.pyrowave_precision_fast'),
            option('1', 'config.pyrowave_precision_balanced'),
            option('2', 'config.pyrowave_precision_full'),
          ]),
          text('pyrowave_device_uuid', { platform: 'linux' }),
        ],
      },
      {
        id: 'video_quality',
